...
class BMI:
    def __init__(self, root):
        ...
        self.root.configure(background="#fffcab")
        # ==================================Frames================================================

        MainFrame = Frame(self.root, bd=20, width=1350, height=700, padx=10, bg="#fffcab", relief=RIDGE)
        MainFrame.grid()

        LeftFrame = Frame(MainFrame, bd=10, width=600, height=600, padx=10, bg="#fffcab", relief=RIDGE)
        LeftFrame.pack(side=LEFT)

        RightFrame = Frame(MainFrame, bd=10, width=560, height=600, padx=10,  bg="#fffcab", relief=RIDGE)
        ...
        LeftFrame2 = Frame(LeftFrame, bd=5, width=712, height=168, padx=5, pady=6, bg="Grey", relief=RIDGE)
        ...
        RightFrame2 = Frame(RightFrame, bd=5, width=522, height=95, padx=5, pady=2, bg="Grey", relief=RIDGE)
        ...
        self.lblTitle = Label(LeftFrame0, text="Body Mass Index", padx=17, pady=4, bd=1,
                              font=('arial', 40, 'bold'), bg='sky blue', width=20)
        self.lblTitle.pack()
        ...
        self.txtBMITable = Text(RightFrame1, height=12, width=53, bd=16,bg="#ffadfe", font=('arial', 12, 'bold'))
        ...
        self.lblHeight = Label(LeftFrame2, text="Enter Height in Meters Square: ", font=('arial', 20, 'bold'), bd=2,
                               justify=LEFT)
        self.lblHeight.grid(row=0, column=0, padx=15)
        self.txtHeight = Entry(LeftFrame2, textvariable=var1, font=('arial', 20, 'bold'), bd=5, width=15, justify=LEFT)
        self.txtHeight.grid(row=0, column=1, pady=10)

        self.lblWeight = Label(LeftFrame2, text="Enter Weight in Kilograms: ", font=('arial', 20, 'bold'), bd=2,
                               justify=LEFT)
        self.lblWeight.grid(row=1, column=0)
        self.txtBodyWeight = Entry(LeftFrame2, textvariable=var2, font=('arial', 20, 'bold'), bd=5, width=15,
                                   justify=RIGHT)
        ...
        self.txtBMIResult = Text(LeftFrame3, padx=105, pady=5, font=('arial', 20, 'bold'), bd=5, bg="sky blue",
                                 relief="sunk",
                                 width=13, height=1)
        self.txtBMIResult.grid(row=0, column=1)
        # =========================================================================================================

        self.btnBMI = Button(LeftFrame1, text="Calculate BMI ", pady=2, padx=4, bd=4, width=12,
                             font=('arial', 20, 'bold'),
                             height=4, command=BMI_Cal)
        self.btnBMI.grid(row=3, column=0)

        self.btnReset = Button(LeftFrame1, text="Reset", pady=2, padx=4, bd=4, width=12,
                               font=('arial', 20, 'bold'),
                               height=4, command=Reset)
        self.btnReset.grid(row=3, column=1)

        self.btnExit = Button(LeftFrame1, text="Exit ", pady=2, padx=4, bd=4, width=12,
                              font=('arial', 20, 'bold'),
